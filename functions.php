...
function addrian_scripts() {
    ...
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/formail.js', array(), '1.0.0', true );
    wp_enqueue_script( 'plugins', get_template_directory_uri() . '/js/jquery.js', array(), '1.0.0', true );
}
